            ...
            <div class="card-body">
                ...
                <form>
                    <div class="row g-3">
                            ...
                            <div class="scroll">
                                <div class="row g-3">
                                    <div class="col-6 col-sm-3">
                                        <div class="card p-2">
                                            <input class="form-check-input mb-2" type="checkbox" value=""
                                                id="checkDefault1" checked>
                                            <label class="form-check-label d-block" for="checkDefault1">
                                                ...
                                                <p class="fw-medium mb-0">N’ Ploy</p>
                                                <p class="fs-14 text-muted">The cutest, most cheerful, and most
                                                    friendly. I'm waiting for you!</p>
                                                <p class="mb-0 fs-12 text-muted"><i class="fi fi-rr-clock"></i> 1 hour,
                                                    1 and a half hours</p>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-6 col-sm-3">
                                        <div class="card p-2">
                                            <input class="form-check-input mb-2" type="checkbox" value=""
                                                id="checkDefault2" checked>
                                            <label class="form-check-label d-block" for="checkDefault2">
                                                <img src="images/background-with-shadow-woman.webp" alt=""
                                                    class="mw-100 mb-2">
                                                <div
                                                    class="d-flex align-items-center justify-content-between w-100 mb-1">
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="card p-2">
                                            <input class="form-check-input mb-2" type="checkbox" value=""
                                                id="checkDefault3">
                                            <label class="form-check-label d-block" for="checkDefault3">
                                                <img src="images/background-with-shadow-woman.webp" alt=""
                                                    class="mw-100 mb-2">
                                                <div
                                                    class="d-flex align-items-center justify-content-between w-100 mb-1">
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="card p-2">
                                            <input class="form-check-input mb-2" type="checkbox" value=""
                                                id="checkDefault4">
                                            <label class="form-check-label d-block" for="checkDefault4">
                                                <img src="images/background-with-shadow-woman.webp" alt=""
                                                    class="mw-100 mb-2">
                                                <div
                                                    class="d-flex align-items-center justify-content-between w-100 mb-1">
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="card p-2">
                                            <input class="form-check-input mb-2" type="checkbox" value=""
                                                id="checkDefault5">
                                            <label class="form-check-label d-block" for="checkDefault5">
                                                <img src="images/background-with-shadow-woman.webp" alt=""
                                                    class="mw-100 mb-2">
                                                <div
                                                    class="d-flex align-items-center justify-content-between w-100 mb-1">
                        ...
                        <div class="col-12">
                            <label for="exampleFormControlInput1" class="form-label fs-14 mb-0">1.Type Room</label>
                            <div class="d-flex gap-2 flex-wrap">
                                <input type="radio" class="btn-check" name="roomType" id="roomType1" autocomplete="off"
                                    checked>
                                <label
                                    class="btn btn-purple-check flex-fill d-flex flex-column rounded-0 justify-content-center"
                                    for="roomType1">
                                    <svg id="Layer_1" class="mb-2 mx-auto" enable-background="new 0 0 53 53"
                                        viewBox="0 0 53 53" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                                                <path
                                ...
                                <input type="radio" class="btn-check" name="roomType" id="roomType2" autocomplete="off">
                                <label
                                    class="btn btn-purple-check flex-fill d-flex flex-column rounded-0 justify-content-center"
                                    for="roomType2">
                                    <svg id="Layer_1" class="mb-2 mx-auto" enable-background="new 0 0 53 53"
                                    ...
                                    Room with bathtub</label>

                                <input type="radio" class="btn-check" name="roomType" id="roomType3" autocomplete="off">
                                <label
                                    class="btn btn-purple-check flex-fill d-flex flex-column rounded-0 justify-content-center"
                                    for="roomType3">
                                    <svg id="Layer_1" class="mb-2 mx-auto" enable-background="new 0 0 53 53"
                                    ...
                                    Special room with bathtub</label>
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <label class="btn btn-purple-check flex-fill rounded-0" for="roomNumber1">FR001</label>

                                <input type="radio" class="btn-check" name="roomNumber" id="roomType2"
                                    autocomplete="off">
                                <label class="btn btn-purple-check flex-fill rounded-0" for="roomNumber2">FR002</label>

                                <input type="radio" class="btn-check" name="roomNumber" id="roomNumber3"
                                    autocomplete="off">
                                <label class="btn btn-purple-check flex-fill rounded-0" for="roomNumber3">FR003</label>
                                <input type="radio" class="btn-check" name="roomNumber" id="roomNumber4"
                                    autocomplete="off">
                                <label class="btn btn-purple-check flex-fill rounded-0" for="roomNumber4">FR004</label>

                                <input type="radio" class="btn-check" name="roomNumber" id="roomType5"
                                    autocomplete="off">
                                <label class="btn btn-purple-check flex-fill rounded-0" for="roomNumber5">FR005</label>

                                <input type="radio" class="btn-check" name="roomNumber" id="roomNumber6"
                                    autocomplete="off">
                                <label class="btn btn-purple-check flex-fill rounded-0" for="roomNumber6">FR006</label>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <label for="exampleFormControlInput1" class="form-label fs-14 mb-0">Duration of service use</label>
                            <div class="d-flex gap-2 flex-wrap">
                                <input type="radio" class="btn-check" name="timeService" id="60min"
                                    autocomplete="off" checked>
                                <label class="btn btn-purple-check flex-fill rounded-0" for="60min">60 minutes/service</label>

                                <input type="radio" class="btn-check" name="timeService" id="90min"
                                    autocomplete="off">
                                <label class="btn btn-purple-check flex-fill rounded-0" for="90min">90 minutes/service</label>
                            </div>
                        </div>
                        <div class="col-12">
                                        ...
                                        <div class="card p-2 mb-2">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    N'Ploy <button type="button" class="btn p-0"><i class="fi fi-rr-circle-xmark text-danger"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card p-2 mb-2">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    N'Game <button type="button" class="btn p-0"><i class="fi fi-rr-circle-xmark text-danger"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <h4 class="text-end text-purple"><span class="fs-12 fw-normal">THB</span> 3,136</h4>
                                        <button class="btn btn-purple rounded-0 w-100" type="submit">Checkout</button>
                                    </div>
                                </div>
                            </div>
                        </div>

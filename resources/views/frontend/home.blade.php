...
<body class="bg-addict bgs-cover">
    ...
    <div class="container">
        ...
        $(document).on('change', 'input[name="ref_branch_id"]', function() {
            ...
            let course = '';
            if ($('.course' + branchId).length === 0) {
                course = `<div class="card border-0 shadow-sm" style="color: purple;">
                            <div class="card-body text-center py-5">
                                <div class="mb-4">
                                    <i class="ti ti-database-off text-secondary"
            ...
            $('.course-list-not-found').html(course);

            $.get('/api/addon-options/' + branchId, function(options) {
                let html = '';
                if (options.length === 0) {
                    html = `<div class="card border-0 shadow-sm" style="color: purple;">
                                <div class="card-body text-center py-5">
                                    <div class="mb-4">
                                        <i class="ti ti-database-off text-secondary"
                                        style="font-size:72px;">
                ...
                updateSummary();
                            ...
                            <div class="col-12">
                                ...
                                <div class='course-list-not-found'>
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input type="hidden" name="total_price" id="value-summary-price" value="0">
    ...
    <script>
        ...
        function loadUsers(branchId) {
            ...
            $.get(`/check-availability/${branchId}`, {
                ...
                let html = `<div class="card border-0 shadow-sm" style="color: purple;">
                                <div class="card-body text-center py-5">
                                    <div class="mb-4">
                                        <i class="ti ti-database-off text-secondary"
                                        style="font-size:72px;">
                ...
                // ✅ bind event ให้ staff ที่เพิ่งโหลดมาใหม่
                $('input[name="selected_user"]').on('change', function() {
                    updateSummary();
                });

                // ✅ ถ้ามี staff ที่ถูกเลือกอยู่แล้ว ให้ update summary เลย
                updateSummary();
            });
        }
    ...
    <script>
        ...
        function updateSummary() {
            ...
            const valueSummaryPrice = document.getElementById('value-summary-price');
                            ...
                            $.ajax({
                                ...
                                error: function(xhr) {
                                    ...
                                    Swal.fire({
                                        ...
                                        text: 'กรุณาเลือกพนักงานและประเภทห้องก่อนทำรายการ \nPlease select a staff and a room type before proceeding.',
                                    });

            ...
            <div
                ...
                <div class="card-body text-center">
                    ...
                    <div class="text-success h5 text-center">
                        <span
                            class="ti-sm ti ti-cash-banknote me-1"></span>
                        4,000/เดือน
                    </div>
                </div>
            </div>
...
<table class="datatables-basic table dataTable no-footer dtr-column"
    id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="font-size: larger;">
    <thead>
    ...
    @foreach ($list_data as $row)
        <tr class="odd">
            ...
            <td>{{ $row->name }}</td>
            <td>
                    @if ($row->rent+$row->furniture_rental > 0)
                        <span
                        class="badge  bg-label-success rounded-pill">
                        {{ number_format($row->rent+$row->furniture_rental) }}/เดือน
                    @else
                        <span
            ...
            <td>
                <button type="button"
                    class="btn btn-main btn-md rounded-pill waves-effect waves-light me-md-2 mb-2 mb-md-0"
                    data-bs-toggle="modal"
                    data-bs-target="#editModal"
                    onclick="view({{ $row->id }})" >
                    <span
                        class="ti-xs ti ti-cash-banknote me-2"></span>กำหนดค่าเช่า
                </button>
            </td>
        </tr>
        {{-- <tr class="even">
            ...
            <td>{{ $row->name }}</td>
            <td><span
                    class="badge  bg-label-success rounded-pill">4,000/เดือน</span>
            </td>
            <td>
                <button type="button"

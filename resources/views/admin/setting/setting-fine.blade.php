                                ...
                                <div class="card mb-3">
                                    <div class="card-header">
                                        <div class="row g-3 justify-content-between">
                                            <div class="col-sm-12">
                                                <h4 class="mb-0">
                                                    <i class="tf-icons ti ti-history text-main ti-md"></i>
                                                    กำหนดค่าปรับ
                                                </h4>
                                                {{-- <input id="myInput" onkeydown="checkEnter(event)">
                                                <script>
                                        ...
                                        <div class="col-lg-8 text-end">
                                            <div class="d-flex justify-content-end flex-column flex-md-row">
                                                ...
                                                <button
                                                    ...
                                                    <span class="ti-xs ti ti-history me-2"></span>กำหนดค่าปรับ
                                                </button>
                                                <button type="button"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg  modal-dialog-scrollable" role="document">
            <div class="modal-content rounded-0">
                    <div class="modal-header rounded-0">
                        <h5 class="modal-title" id="exampleModalLabel1">กำหนดค่าปรับ</h5>

        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content rounded-0">
                <div class="modal-header rounded-0">
                    <h5 class="modal-title" id="exampleModalLabel1">&nbsp;เพิ่มการขายสินค้า</h5>
                ...
                <form id="insert_user" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row g-3 p-4">
                            ...
                            {{-- <div class="col-sm-6">
                                <label for="" class="form-label">บัตรการขายสินค้า</label><span class="text-danger"> *</span>
                                <input name="user_code" type="password" class="form-control" placeholder="บัตรการขายสินค้า" required />
                            </div> --}}
                            <div class="col-sm-6">
                            </div>
                            <div class="col-sm-6">
                                <label for="" class="form-label">ชื่อการขายสินค้า</label><span class="text-danger"> *</span>
                                <input name="name" type="text" class="form-control" placeholder="ชื่อการขายสินค้า" required />
                            </div>
                            <div class="col-sm-6">
                                <label for="" class="form-label">ราคาขาย</label><span class="text-danger"> *</span>
                                <input name="price" type="text" class="form-control" placeholder="ราคาขาย" required />
                            </div>
                            <div class="col-sm-6">
                                <label for="" class="form-label">ต้นทุน</label><span class="text-danger"> *</span>
                                <input name="cost" type="text" class="form-control" placeholder="ต้นทุน" required />
                            </div>
                            <div class="col-sm-6">

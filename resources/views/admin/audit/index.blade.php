                                                ...
                                                <ul class="nav nav-pills nav-fill " role="tablist">
                                                    <li class="nav-item me-4">
                                                        ...
                                                        style="background-color: #d6f4f7;color: black;"
                                                            ...
                                                            aria-selected="true">ใบแจ้งหนี้</button>
                                                    </li>
                                                    <li class="nav-item">
                                                        ...
                                                        style="background-color: #ffe2e3;color: black;"
                                                            ...
                                                            aria-selected="false">ใบเสร็จรับเงิน</button>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="tab-content p-0">
                                                            ...
                                                            <table class="datatables-basic table dataTable no-footer dtr-column"
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr class="odd">
                                                                            ...
                                                                            <td class="text-center text-sucess">
                                                                                ชำระเงินแล้ว
                                                                            </td>
                                                                            <td class="text-center">
                                                                                รูปภาพ
                                            ...
                                            <div class="tab-pane fade" id="navs-pills-top-profile" role="tabpanel">
                                                ...
                                                <div class="row border-bottom border-light p-3">
                                                    ...
                                                    <div class="col-md-3 text-end align-items-center" style="padding-right: unset !important;">
                                                            <h4 style="padding: 0.422rem 0.875rem 0;" class="mb-2">พฤษภาคม 2024</h4>
                                                    </div>

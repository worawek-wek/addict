                                ...
                                <div class="d-flex">
                                    <div class="col-sm-5">
                                        <ul class="list-unstyled mb-4 mt-2" style="padding: 0 20px;">
                                            ...
                                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">สาขา:</span> <span>{{ $product->branch->name }}</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                            <i class="ti ti-crown text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">คงเหลือ:</span> <span>{{ \App\Models\CardStocks::where('ref_product_id', $product->id)->latest()->value('remain') ?? 0 }}</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">ชื่อ:</span> <span>{{ $product->name }}</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">ราคาขาย:</span> <span>{{ $product->price }}</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">ต้นทุน:</span> <span>{{ $product->name }}</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                            <i class="ti ti-file-description text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">หมายเหตุ:</span> <span>{{ $product->remark }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="row g-3 p-4">
                                <div class="col-sm-6">
                                    <label for="" class="form-label">สาขา</label><span class="text-danger"> *</span><br>
                                      <input class="form-check-input" type="radio" name="ref_branch_id" id="inlineRadio3" value="1" @if ($product->ref_branch_id == 1) checked @endif>
                                      <label class="form-check-label me-4" for="inlineRadio3">อ่อนนุช</label>
                                      <input class="form-check-input" type="radio" name="ref_branch_id" id="inlineRadio4" value="2" @if ($product->ref_branch_id == 2) checked @endif>
                                      <label class="form-check-label" for="inlineRadio4">ทองหล่อ</label>
                                </div>
                                <div class="col-sm-6">
                                </div>
                                <div class="col-sm-6">
                                    <label for="" class="form-label">ชื่อสินค้า</label><span class="text-danger"> *</span>
                                    <input name="name" type="text" class="form-control" placeholder="ชื่อสินค้า" required value="{{ $product->name }}" />
                                </div>
                                <div class="col-sm-6">
                                    <label for="" class="form-label">ราคาขาย</label><span class="text-danger"> *</span>
                                    <input name="price" type="text" class="form-control" placeholder="ราคาขาย" required value="{{ $product->price }}"/>
                                </div>
                                <div class="col-sm-6">
                                    <label for="" class="form-label">ต้นทุน</label><span class="text-danger"> *</span>
                                    <input name="cost" type="text" class="form-control" placeholder="ต้นทุน" required value="{{ $product->cost }}" />
                                </div>
                                {{-- <div class="col-sm-6">

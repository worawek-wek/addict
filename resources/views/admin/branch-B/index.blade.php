          ...
          <div class="card">
            <div class="card-body">
              <!-- Logo -->
                ...
                <!-- Logo -->
                <div class="app-brand mb-4 mt-4">
                    <img src="{{url('')}}/assets/img/illustrations/main.png" alt="" style="margin: auto;">
                </div>
                <!-- /Logo -->
                <h4 class="text-center">
                    <span>ยังไม่มีอพาร์ตเมนต์ในระบบ</span>
                </h4>
                <div class="mb-3">
                <button onclick="location.href='{{ url("branch/add") }}';" class="btn btn-main w-100" type="submit"><i class="ti ti-plus"></i> เพิ่มสาขา</button>
                </div>

...
@section('subcontent')
                        ...
                        <div class="flex-1 mt-6 xl:mt-0">
                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                <div class="col-span-12 2xl:col-span-6">
                                    ...
                                    <div class="mt-3">
                                        <label for="update-profile-form-1" class="form-label">ชื่อเล่น</label>
                                        <input name="nickname" id="update-profile-form-1" type="text" class="form-control" placeholder="ชื่อเล่น" value="{{ @$user['nickname'] }}">
                                    </div>
                                    <div class="mt-3 mb-3">
                                    ...
                                    <div class="mt-3 2xl:mt-0">
                                        <label for="update-profile-form-6" class="form-label">เพศ</label>
                                        <div class="flex flex-col sm:flex-row mt-2">
                                            <div class="form-check mr-2">
                                                <input id="radio-switch-4" class="form-check-input" type="radio" name="gender" value="1" @if(@$user['gender'] == 1) checked @endif>
                                                <label class="form-check-label" for="radio-switch-4">ชาย</label>
                                            </div>
                                            <div class="form-check mr-2 mt-2 sm:mt-0">
                                                <input id="radio-switch-5" class="form-check-input" type="radio" name="gender" value="2" @if(@$user['gender'] == 2) checked @endif>
                                                <label class="form-check-label" for="radio-switch-5">หญิง</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" class="datepicker form-control pl-12" name="work_start_date" id="update-profile-form-3" placeholder="Work start date" value="{{@$user->work_start_date}}" data-single-mode="true" onchange="workkingCalcu(this.value)">
                                    </div>
                                    <div class="mt-3">
                                        <label for="update-profile-form-99" class="form-label">อายุงาน</label>
                                        <input id="update-profile-form-99" type="text" class="form-control" placeholder="อายุงาน" disabled>
                                    </div>
                                    <div class="mt-3">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" class="datepicker form-control pl-12" name="birthday" id="update-profile-form-4" placeholder="Work start date" value="{{@$user->birthday}}" data-single-mode="true" onchange="oldCalcu(this.value)">
                                ...
                                <div class="col-span-12 2xl:col-span-6">
                                    <div class="mt-3 2xl:mt-0">
                                        ...
                                        <select name="ref_branch_id" id="update-profile-form-6" data-search="true" class="tom-select w-full" onchange="checkLacanal(this.value)">
                                    ...
                                    <div class="mt-3 div_schedule" @if (@$user['ref_branch_id'] != 8) style="display: none;" @endif>
    ...
    <script>
        ...
        function workkingCalcu(){
            let Startday = document.getElementById("update-profile-form-3").value;
            document.getElementById("update-profile-form-99").value = ageCalcu(Startday);
        }
        function oldCalcu(){
            let Birthday = document.getElementById("update-profile-form-4").value;
            document.getElementById("update-profile-form-5").value = ageCalcu(Birthday);
        }

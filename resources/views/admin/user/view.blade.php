                                ...
                                <div class="d-flex">
                                        ...
                                        <ul class="list-unstyled mb-4 mt-2" style="padding: 0 20px;">
                                            ...
                                            <li class="d-flex align-items-center mb-3">
                                                <i class="ti ti-check text-heading"></i><span
                                                    class="fw-medium mx-2 me-4 text-heading">สถานะ:</span>
                                            ...
                                            <li class="d-flex align-items-center mb-3">
                                                <i class="ti ti-crown text-heading"></i><span
                                                    class="fw-medium mx-2 me-4 text-heading">ตำแหน่ง:</span>
                                    ...
                                    <div class="col-sm-5">
                                        <ul class="list-unstyled mb-4 mt-2" style="padding: 0 20px;">
                                            <li class="d-flex align-items-center mb-3">
                                                <i class="ti ti-user text-heading"></i><span
                                                    class="fw-medium mx-2 me-4 text-heading">Username:</span>
                                                <span>{{ $user->email }}</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                                <img src="/upload/user/{{ $user->image_name }}" alt=""
                                                    width="100px">
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="row g-3 p-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input name="user_code" type="password" class="form-control"
                                                placeholder="บัตรพนักงาน" value="{{ $user->user_code }}"
                                                id="user_code_up" required />
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="" class="form-label">ชื่อพนักงาน</label><span
                                                class="text-danger"> *</span>
                                            <input name="name" value="{{ $user->name }}" type="text"
                                                class="form-control" placeholder="ชื่อพนักงาน" required />
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="" class="form-label">ชื่อเล่น</label><span
                                                class="text-danger"> *</span>
                                            <input name="nickname" value="{{ $user->nickname }}" type="text"
                                                class="form-control" placeholder="ชื่อเล่น" required />
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <select name="ref_position_id" id="select2EditPosition"
                                                ...
                                                @foreach ($position as $pos)
                                                    <option value="{{ $pos->id }}"
                                                        @if ($user->ref_position_id == $pos->id) selected @endif>
                                                        {{ $pos->position_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-10 mt-3">
                                            ...
                                            @if ($user->image_name == '')
                                                <div class="preview-container">
                                                    <img id="preview2" src="" alt="Preview 1"
                                                        style="display: none; width:30%">
                                                </div>
                                            @else
                                                <div class="preview-container">
                                                    <img id="preview2" src="/upload/user/{{ $user->image_name }}"
                                                        alt="Preview 1" style="width:30%">
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-span-12">
                                            <div class="col-sm-6 mt-3">
                                                ...
                                                <input name="email" value="{{ $user->email }}" type="text"
                                                    class="form-control" placeholder="ชื่อผู้ใช้" required />
                                            </div>
                                            <div class="col-sm-6 mt-3">
                                                <label for="update-profile-form-2" class="form-label">รหัสผ่าน <span
                                                        class="text-warning">(กรณีเปลี่ยนรหัสผ่าน)</span></label>
                                                <input name="password" id="password2" type="password"
                                                    class="form-control" placeholder="รหัสผ่าน">
                                            </div>
                                            <div class="col-sm-6 mt-3">
                                                <label for="update-profile-form-3" class="form-label">ยืนยัน
                                                    รหัสผ่าน</label>
                                                <input id="confirm_password2" type="password" class="form-control"
...
<script>
    ...
    $(document).ready(function() {
        $('#select2EditPosition').select2({
            dropdownParent: $('#insurance'), // ให้ dropdown อยู่ใน modal

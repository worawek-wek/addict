                    ...
                    <div class="nav-align-top mb-4">
                        ...
                        <div class="tab-content" style="box-shadow: unset;padding:0px">
                                    ...
                                    <div class="col-sm-5">
                                        <ul class="list-unstyled mb-4 mt-2" style="padding: 0 20px;">
                                            ...
                                            <li class="d-flex align-items-center mb-3">
                                                ...
                                                <span>{{ $drink->remark }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-5" align="right">
                                            {!! QrCode::size(200)->generate(url('/pos/drink/'.$drink->id)) !!}
                                    </div>
                            ...
                            <div class="tab-pane fade" id="navs-pills-top-edit" role="tabpanel">
                                ...
                                <form id="edit_drink" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row g-3 p-4">
                                        ...
                                        <div class="col-sm-6">
                                            <label for="" class="form-label">ชื่อดื่ม</label><span
                                                class="text-danger"> *</span>
                                            <input name="name" type="text" class="form-control"
                                                placeholder="ชื่อดื่ม" required value="{{ $drink->name }}" />
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        {{-- <div class="col-sm-6">
                                            ...
                                            <input name="cost" type="text" class="form-control"
                                                placeholder="ต้นทุน" required value="{{ $drink->cost }}" />
                                        </div> --}}
                                        {{-- <div class="col-sm-6">
                                    <label for="" class="form-label">คงเหลือ</label><span class="text-danger"> *</span>
                                    <input name="stock" type="text" class="form-control" placeholder="คงเหลือ" required value="{{ $drink->stock }}"/>
                                </div> --}}
                                        <script>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <textarea name="remark" class="form-control">{{ $drink->remark }}</textarea>
                                        </div>
                                    </div>
...
<script>
    $('#edit_drink').on('submit', function(event) {
        ...
        Swal.fire({
            ...
            text: 'คุณต้องการ แก้ไข ดื่ม หรือไม่?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ $page_url }}/{{ $drink->id }}', // เปลี่ยน URL เป็นจุดหมายที่ต้องการ
                    type: 'POST',
                    data: formData,
                    ...
                    success: function(response) {
                        if (response == true) {
                            Swal.fire('แก้ไขดื่มเรียบร้อยแล้ว', '', 'success');
                            loadData(page);
                            view('{{ $drink->id }}');
                        }
                    },

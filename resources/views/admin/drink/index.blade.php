...
<body>
                                                ...
                                                <div class="row p-3">
                                                    ...
                                                    <div class="col-md-8 flex text-end"
                                                        ...
                                                        <button
                                                            ...
                                                            <span><i class="ti ti-package-export"></i> เบิกดื่ม</span>
                                                        </button>
                                                        <button
                                                            style="padding-right: 14px;padding-left: 14px;margin-right: 0px;"
                                                            ...
                                                            <span><i class="ti ti-plus"></i> เพิ่มดื่ม</span>
                                                        </button>
                                                    </div>
                                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content rounded-0">
                <div class="modal-header rounded-0">
                    <h5 class="modal-title" id="exampleModalLabel1">&nbsp;เบิกดื่ม</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="withdraw_drink" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade modalHeadDecor" id="addserviceModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content rounded-0">
                <div class="modal-header rounded-0">
                    <h5 class="modal-title" id="exampleModalLabel1">&nbsp;เพิ่มดื่ม</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="insert_user" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row g-3 p-4">
                            ...
                            <div class="col-sm-6">
                                <label for="" class="form-label">ชื่อดื่ม</label><span class="text-danger">
                                    *</span>
                                <input name="name" type="text" class="form-control" placeholder="ชื่อดื่ม"
                                    required />
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <label for="" class="form-label">ค่ามือ</label><span class="text-danger">
                                    *</span>
                                <input name="commission" type="text" class="form-control" placeholder="ราคาขาย"
                                    required />
                            </div>
                            <script>
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function (response) {
                        if (response == true) {
                            Swal.fire('ลบดื่มเรียบร้อยแล้ว', '', 'success');
                            loadData(page);
                        }
                    },
                    error: function () {
...
//////////////////////////////////////////////////////////////////////////////////////////////
    $('#withdraw_drink').on('submit', function(event) {
        ...
        Swal.fire({
            title: 'ยืนยันการดำเนินการ?',
            text: 'คุณต้องการเบิกดื่มหรือไม่?',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'ตกลง',
            cancelButtonText: 'ยกเลิก',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '/admin/drink/withdraw-drink',
                    type: 'POST',
                    data: formData,
                    ...
                    success: function(response) {
                        if (response == true) {
                            $('#withdraw_drink')[0].reset();
                            Swal.fire('เบิกดื่มเรียบร้อยแล้ว', '', 'success');
...
//////////////////////////////////////////////////////////////////////////////////////////////
    $('#insert_user').on('submit', function(event) {
        ...
        Swal.fire({
            title: 'ยืนยันการดำเนินการ?',
            text: 'คุณต้องการเพิ่มดื่มหรือไม่?',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'ตกลง',
            cancelButtonText: 'ยกเลิก',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function(response) {
                        if (response == true) {
                            $('#insert_user')[0].reset();
                            Swal.fire('เพิ่มดื่มเรียบร้อยแล้ว', '', 'success');
...
//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $('#select2drink').select2({ dropdownParent: $('.card-body') });

...
<body>
                                                ...
                                                <div class="row p-3">
                                                    ...
                                                    <div class="col-md-3 flex text-end" style="padding-right: unset !important;">
                                                        ...
                                                        <button
                                                            ...
                                                            <span><i class="ti ti-plus"></i> นำเข้าดื่ม</span>
                                                        </button>
                                                    </div>
                                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content rounded-0">
                <div class="modal-header rounded-0">
                    <h5 class="modal-title" id="exampleModalLabel1">&nbsp;นำเข้าดื่ม</h5>
                ...
                <form id="insert_user" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row g-3 p-4">
                            <div class="col-sm-6">
                                <label for="" class="form-label">ดื่ม</label>
                                <select name="ref_drink_id" id="select2Position1" class="select2 form-select form-select-lg" data-allow-clear="true">
    ...
    <script>
        ...
        function printPdf(){
            ...
            window.open(
                '/admin/drink_card_stock_report/pdf?' + queryString,
                '_blank'
            );
        }
        ...
        $('#insert_user').on('submit', function(event) {
            ...
            Swal.fire({
                ...
                text: 'คุณต้องการนำเข้าดื่มหรือไม่?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response == true) {
                                $('#insert_user')[0].reset();
                                Swal.fire('นำเข้าดื่มเรียบร้อยแล้ว', '', 'success');

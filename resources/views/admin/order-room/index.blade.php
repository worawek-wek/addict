                                                ...
                                                <div class="col-sm-2 mb-2">
                                                    <select name="branch_id" class="form-select p_search"
                                                        ...
                                                        @foreach ($branches as $branch)
                                                            <option value="{{ $branch->id }}" @if (!($canViewAllBranches ?? false) && Auth::user()->ref_branch_id == $branch->id) selected @endif>{{ $branch->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
    ...
    <script>
        ...
        function onDateRangeChange() {
            ...
            if (val === 'custom') {
                ...
                $('#start_time_filter').val("{{ \App\Support\AdminBusinessDay::START_TIME }}");
                $('#end_time_filter').val("{{ \App\Support\AdminBusinessDay::END_TIME }}");
            }

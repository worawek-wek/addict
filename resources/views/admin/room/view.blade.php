                                ...
                                <div class="d-flex">
                                    <div class="col-sm-12">
                                        <ul class="list-unstyled mb-4 mt-2" style="padding: 0 20px;">
                                            ...
                                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">สาขา:</span> <span>{{ $room->branch->name }}</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">ชื่อ:</span> <span>{{ $room->name }}</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">ราคา 1 ชั่วโมง/บริการ:</span> <span>{{ $room->sixty_minutes }}</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">ราคา 1 ชั่วโมงครึ่ง/บริการ:</span> <span>{{ $room->ninety_minutes }}</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                            <i class="ti ti-file-description text-heading"></i><span class="fw-medium mx-2 me-4 text-heading">หมายเหตุ:</span> <span>{{ $room->remark }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                      ...
                      <div class="tab-pane fade" id="navs-pills-top-edit" role="tabpanel">
                        ...
                        <form id="edit_room" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 p-4">
                                ...
                                <div class="col-sm-6">
                                    <label for="" class="form-label">ชื่อห้อง</label><span class="text-danger"> *</span>
                                    <input name="name" type="text" class="form-control" placeholder="ชื่อห้อง" required value="{{ $room->name }}" />
                                </div>
                                <div class="col-sm-6">
                                    <label for="" class="form-label">ราคา 1 ชั่วโมง/บริการ</label><span class="text-danger"> *</span>
                                    <input name="sixty_minutes" type="text" class="form-control" placeholder="ราคา 1 ชั่วโมง/บริการ" required value="{{ $room->sixty_minutes }}"/>
                                </div>
                                <div class="col-sm-6">
                                    <label for="" class="form-label">ราคา 1 ชั่วโมงครึ่ง/บริการ</label><span class="text-danger"> *</span>
                                    <input name="ninety_minutes" type="text" class="form-control" placeholder="ราคา 1 ชั่วโมงครึ่ง/บริการ" required value="{{ $room->ninety_minutes }}" />
                                </div>
                                <script>
...
<script>
    ...
    $('#edit_room').on('submit', function(event) {
            ...
            Swal.fire({
                ...
                text: 'คุณต้องการ แก้ไข ห้องชื่อห้อง หรือไม่?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            if(response == true){
                                Swal.fire('แก้ไขห้องชื่อห้องเรียบร้อยแล้ว', '', 'success');
                                loadData(page);
                                view('{{$room->id}}');
                            }
                        },

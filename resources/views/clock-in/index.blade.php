...
<html
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">ADDICT/</span> แตะบัตรเข้างาน</h4>
    ...
    <script>
      ...
      // document.getElementById("ClockIn").addEventListener("keydown", function(event) {
      //     if (event.key === "Enter") {

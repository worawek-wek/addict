                                                ...
                                                <div class="d-flex gap-2 flex-wrap">
                                                    @foreach ($course as $key_2 => $course_item)
                                                        <input type="radio"
                                                            ...
                                                            @if ($key_2 == 0) checked @endif
                                                            >

                                                        <label class="btn btn-course flex-fill rounded-0"

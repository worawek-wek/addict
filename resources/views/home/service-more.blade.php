      ...
      <form id="insert_service">
        ...
        {{-- <input type="hidden" name="ref_user_id" value="{{ $user->id }}"> --}}
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="pt-3 mb-0"><span class="text-muted fw-light">Addict /</span> สั่งเพิ่มเติม</h4>
              <div class="card g-3 mt-5">
                <div class="card-body row g-3">
                  ...
                  <div class="col-lg-4">
                  <div class="card mb-4" style="position: fixed;bottom: 0px;">
                    <div class="card-body">
                      <div class="ms-3">
                        <h5 class="mb-2">ลูกค้า</h5>
                        <p class="mb-0 pt-1">
                            {{ $customer->name }}
                        </p>
                      </div>
                      <div class="ms-3 mt-2">
                        <h5 class="mb-2">มาม่า</h5>
                        <p class="mb-0 pt-1">
                          {{ $mama->name }}
                        </p>
                      </div>

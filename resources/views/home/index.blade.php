...
<html
  ...
  <head>
    ...
    <title>My Courses - Academy | Vuexy - Bootstrap Admin Template</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">ADDICT/</span> จองบริการนวด</h4>
                  ...
                  <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-4">
                    ...
                    <div class="app-academy-md-50 card-body d-flex align-items-md-center flex-column text-md-center">
                      <h3 class="card-title mb-4 lh-sm px-md-5 lh-lg">
                        บริการนวด ผ่อนคลาย
                        <span class="text-primary fw-medium text-nowrap">ทั้งหมดอยู่ที่นี่แล้ว</span>.
                      </h3>
                      <p class="mb-3">
                        ค้นหาชื่อน้อง ๆ หรือ สาขา ได้เลย
                      </p>
                      <div class="d-flex align-items-center justify-content-between app-academy-md-80">
                        <input type="search" placeholder="ชื่อ, สาขา" class="form-control me-2" />
                  ...
                  <div class="card-header d-flex flex-wrap justify-content-between gap-3">
                    ...
                    <div class="d-flex justify-content-md-end align-items-center gap-3 flex-wrap">
                      <select id="select2_course_select" class="select2 form-select" data-placeholder="ทุกสาขา">
                        ...
                        <option value="ui/ux">สาขา 1</option>
                        <option value="ui/ux">สาขา 2</option>
                        <option value="ui/ux">สาขา 3</option>
                        <option value="ui/ux">สาขา 4</option>
                        <option value="ui/ux">สาขา 5</option>
                      </select>
                    </div>
                  </div>
                  <div class="card-body">
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div class="card p-2 h-100 shadow-none border">
                          <div class="rounded-2 text-center mb-3">
                            <a href="{{session('branch_id')}}/service/{{$row->id}}"
                              ><img
                                class="img-fluid"
                                src="/upload/user/{{ $row->image_name }}"
                                alt="tutor image 1"
                            /></a>
                          </div>
                          <div class="card-body p-3 pt-2">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                              <span class="badge bg-label-primary">ยอดนิยม</span>
                              <h6 class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                4.4 <span class="text-warning"><i class="ti ti-star-filled me-1 mt-n1"></i></span
                                ><span class="text-muted">(1.23k)</span>
                              </h6>
                            </div>
                            <a href="{{session('branch_id')}}/service/{{$row->id}}" class="h5">น้อง{{ $row->nickname }}</a>
                            <p class="mt-2">น่ารัก สดใส เป็นกันเองที่สุด กำลังรอพี่อยู่นะคะ.!</p>
                            <p class="d-flex align-items-center"><i class="ti ti-clock me-2 mt-n1"></i>1 ชั่วโมง , 1 ชั่วโมงครึ่ง</p>
                            ...
                            <div class="d-flex flex-column flex-md-row gap-2 text-nowrap">
                              <a class="app-academy-md-50 btn btn-label-secondary me-md-2 d-flex align-items-center"
                                href="{{session('branch_id')}}/service/{{$row->id}}">
